var data = [
    { "name": "Shoes", "Q1": 40, "Q2": 25, "Q3": 15 },
    { "name": "Hats", "Q1": 50, "Q2": 40, "Q3": 30 },
    { "name": "Coats", "Q1": 35, "Q2": 45, "Q3": 20 },
    { "name": "Scarves", "Q1": 20, "Q2": 15, "Q3": 30 }
];

var data2 = [
    { "name": "Shoes", "Q1": 20, "Q2": 35, "Q3": 35 },
    { "name": "Hats", "Q1": 30, "Q2": 40, "Q3": 45 },
    { "name": "Coats", "Q1": 45, "Q2": 25, "Q3": 30 },
    { "name": "Scarves", "Q1": 10, "Q2": 25, "Q3": 20 },
    { "name": "Socks", "Q1": 55, "Q2": 15, "Q3": 15 },
    { "name": "Sweaters", "Q1": 50, "Q2": 35, "Q3": 50 }
];
...
var LineKeyFrame = function () {
    KeyFrame.call(this);
};
LineKeyFrame.prototype = Object.create(KeyFrame.prototype);
LineKeyFrame.prototype.addLine = function (
    x, y) {
...
LineKeyFrame.prototype.clear = function () {
    KeyFrame.prototype.clear.call(this);
};
LineKeyFrame.prototype.interpolate = function (p, previous, next) {
    KeyFrame.prototype.interpolate.call(this, p, previous, next);
};
...
var LineSeries = function (chart) {
    ChartElement.call(this, chart);
    this._displayFrame = new LineKeyFrame();
    this._previousFrame = new LineKeyFrame();
    this._nextFrame = new LineKeyFrame();
    this._valueAccessor = null;
    this._color = "rgba(255, 0, 0, 1)";
};
LineSeries.prototype = Object.create(ChartElement.prototype);
LineSeries.prototype._populateDefaultFrame = function (frame, nextFrame) {
    for (var i = 0; i < nextFrame.xPositions.length; i++) {
        frame.xPositions[i] = nextFrame.xPositions[i];
        frame.yPositions[i] = this._chart._plotTop + this._chart._plotHeight;
    }
};
LineSeries.prototype._validate = function () {
    if (this._valueAccessor === null) {
        return false;
    }
    return ChartElement.prototype._validate.call(this);
};
LineSeries.prototype._render = function (ctx) {
    var f = this._displayFrame;
    var currX, currY,
        currColor;
...
LineSeries.prototype.valueAccessor = function (accessor) {
    this._valueAccessor = accessor;
    this._update();
    return this;
};
LineSeries.prototype._updateFrame = function (frame) {
    var data = this._chart._data;
    
    var offset = this._chart.groupWidth() / 2.0;
    var val, scaledX, scaledY;
...
Chart.prototype.groupWidth = function () {
    var fullWidth = this._plotWidth / this._data.length;
    return fullWidth;
};
Chart.prototype.groupingSeriesCount = function () {
    return this._series.filter(function (item) {
        return item instanceof ColumnSeries;
    }).length;
};
Chart.prototype.seriesWidth = function () {
    var fullWidth = this._plotWidth / this._data.length;
    var actualWidth = fullWidth * (1.0 - this._gap);
    actualWidth /= this.groupingSeriesCount();
    return actualWidth;
};
